...
const FlashCard = memo(({ id, front, back, lastModified, status, handleUpdate, handleDelete,isSelected, handleSelectCard,isShareMode,provided }) => {
  ...
  return (
    ...
    className={`flashcard ${isSelected ? 'selected' : ''}`} onClick={toggleFlipCard}>
